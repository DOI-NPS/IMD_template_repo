...
## IMD Repositories:
Repositories created by or for the Inventory and Monitoring Division on NPS **must include the following keywords ("topics"): nrss, imd**. See the IMD SharePoint pages for how to [add keywords](https://doimspp.sharepoint.com/sites/nps-nrss-imdiv/publication/SitePages/DGEC-Requirements.aspx#keywords) to a repository.
